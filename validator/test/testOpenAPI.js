            ...
            describe("OpenAPI - " + filename, function () {
              ...
              describe(" - Schemas: ", function () {
                ...
                it("should be dereferenced. This means all external references are correct (FilePaths and Object property names)", function () {
                  if (!derefErrorDetail || (typeof value === "string" && !derefErrorDetail.includes("ETIMEDOUT"))) { //Não contar como erro de dereference casos de timeout que podem ter sido ocasionados pela rede no Travis
